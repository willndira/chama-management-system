<div id="page-wrapper">
    <div class="graphs">
        <div class="xs">
            <h3>Group Pending Deposit</h3>
            <div class="col-md-3 email-list1">
                <?php echo form_open('Admin/pendingDeposit'); ?>
                <ul class="collection">
                ...
                <div class="mailbox-content">
                    ...
                    if (count($allContribution)) {
                        ...
                        <table class="table">
                            ...
                            <th>First Name</th>
                            <th>Middle Name</th>
                            <th>Contribution Pending Amount</th>
                            </thead>
                            <tbody>
                                <?php
                                foreach ($allContribution as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo ($row->contribution_expected_amount - $row->contribution_amount); ?>
                                            </font>
                                    </tr>
                                    <?php
                                }
