...
<div style="width:500px; height:135px; overflow:auto; color:#000000; margin-bottom:20px;" align="center">
    ...
    <script>
        ...
        var key = '<?php echo $this->security->get_csrf_token_name();?>';
                var token = '<?php echo $this->security->get_csrf_hash();?>';
                $.ajax({
                type: 'POST',
                        dataType: 'json',
                        url: "<?php echo site_url("evencal/do_add"); ?>",
                        data: $('<?php echo "year:$year,mon:$mon,day:$day"; ?>, hour:$('#hour').val(), minute: $('#minute').val(), event:$('#event').val()').serialize() + "&" + key + "=" + token,
